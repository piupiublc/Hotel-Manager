          ...
          {user ? (
            <div className="flex items-center gap-4">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-56 origin-top-right rounded-xl bg-white shadow-2xl ring-1 ring-black/5 py-2 z-[100] animate-in fade-in zoom-in duration-100">
            ...
            <>
              <Link
                href="/login"
                className="hidden sm:flex px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-100 rounded-lg transition-all"
              >
                Log in
              </Link>
              <Link
