...
export function PublicFooter() {
  return (
    <footer className="border-t border-slate-200 bg-white px-6 md:px-12 py-12 mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="flex flex-col gap-6 max-w-xs">
            <Link href="/" className="flex items-center gap-2 text-primary hover:opacity-80 transition-opacity">
              ...
              <span className="text-xl font-bold tracking-tight text-slate-900">StayMaster</span>
            </Link>
            ...
            <div className="flex gap-4">
               {/* Social placeholders */}
               <div className="h-8 w-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-400">f</div>
               <div className="h-8 w-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-400">t</div>
               <div className="h-8 w-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-400">i</div>
            </div>
          </div>
          
          <div>
            <h4 className="font-bold text-sm uppercase tracking-wider text-slate-900 mb-6">Sản phẩm</h4>
          ...
          <div>
            <h4 className="font-bold text-sm uppercase tracking-wider text-slate-900 mb-6">Hố trợ</h4>
            <ul className="flex flex-col gap-4 text-sm">
          ...
          <div>
            <h4 className="font-bold text-sm uppercase tracking-wider text-slate-900 mb-6">Bản tin</h4>
            <p className="text-sm text-slate-500 mb-4">Nhận thông tin mới nhất về xu hướng lưu trú.</p>
            <div className="flex gap-2">
              <input 
                className="w-full bg-slate-100 border-none rounded-xl text-sm px-4 py-2 focus:ring-1 focus:ring-primary focus:outline-none" 
