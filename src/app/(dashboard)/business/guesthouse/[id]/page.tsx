      ...
      <div className="max-w-5xl w-full flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-4">
          <nav className="flex items-center gap-2 text-slate-500  text-sm">
            ...
            <span className="text-slate-900  font-medium">Cozy Mountain Guesthouse</span>
          </nav>
          <div className="flex flex-wrap justify-between items-end gap-4">
            <div className="flex flex-col gap-2">
              <h1 className="text-slate-900  text-4xl font-extrabold tracking-tight">Cozy Mountain Guesthouse</h1>
              <p className="text-slate-500  text-lg">Manage your property details, amenities, and media from a single place.</p>
            </div>
            <div className="flex gap-3">
              <button className="flex items-center justify-center rounded-lg h-10 px-4 bg-slate-100  text-slate-900  text-sm font-bold border border-slate-200 ">
        ...
        <div className="border-b border-slate-200  flex gap-8 overflow-x-auto no-scrollbar">
          ...
          <button className="flex items-center gap-2 border-b-2 border-transparent text-slate-500  pb-4 px-2 font-medium hover:text-slate-700  whitespace-nowrap">
            ...
            <section className="bg-white  rounded-xl p-6 shadow-sm border border-slate-200 ">
              ...
              <div className="grid grid-cols-1 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input className="rounded-lg border-slate-200  bg-slate-50   focus:ring-primary focus:border-primary w-full" type="text" value="Cozy Mountain Guesthouse" />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-bold text-slate-700 ">Description</label>
                  <textarea className="rounded-lg border-slate-200  bg-slate-50   focus:ring-primary focus:border-primary w-full" rows={6}>Nestled in the heart of the Blue Ridge Mountains, our guesthouse offers a perfect blend of rustic charm and modern luxury. Ideal for couples seeking a quiet retreat or small families looking for outdoor adventure. Featuring panoramic views, a private deck, and a wood-burning fireplace.</textarea>
                </div>
              </div>
            </section>
            {/*  Card: Location  */}
            <section className="bg-white  rounded-xl p-6 shadow-sm border border-slate-200 ">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input className="rounded-lg border-slate-200  bg-slate-50   focus:ring-primary focus:border-primary w-full" type="text" value="123 Alpine Way" />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-bold text-slate-700 ">City</label>
                  <input className="rounded-lg border-slate-200  bg-slate-50   focus:ring-primary focus:border-primary w-full" type="text" value="Asheville" />
                </div>
                <div className="md:col-span-2">
                  <div className="w-full h-48 rounded-lg overflow-hidden relative group">
                    ...
                    <div className="absolute bottom-4 left-4">
                      <button className="bg-white  px-3 py-1.5 rounded-lg text-xs font-bold shadow-lg flex items-center gap-1 border border-slate-200 ">
          ...
          <div className="flex flex-col gap-6">
            ...
            <section className="bg-white  rounded-xl p-6 shadow-sm border border-slate-200 ">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-2 border-b border-slate-100 ">
                  <span className="text-slate-600  text-sm">Occupancy Rate</span>
            ...
            <section className="bg-primary/5  rounded-xl p-6 border border-primary/20">
              ...
              <div className="grid grid-cols-1 gap-3">
                <button className="flex items-center gap-3 w-full p-3 rounded-lg bg-white  shadow-sm border border-slate-100  hover:border-primary transition-all text-left">
