...
<div className="text-slate-400 flex bg-white  items-center justify-center pl-6">
<span className="material-symbols-outlined">search</span>
</div>
<input className="form-input flex w-full flex-1 border-none bg-white  focus:ring-0 text-slate-900  h-full placeholder:text-slate-400 px-4 text-lg font-normal" placeholder="Search for help articles, FAQs, and more..." value="" />
<div className="bg-white  pr-3 flex items-center">
...
<h2 className="text-slate-900  text-[22px] font-bold leading-tight tracking-[-0.015em]">Browse by Category</h2>
<a className="text-primary text-sm font-bold hover:underline" href="#">View All Topics</a>
</div>
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-4">
{/*  Category Card 1  */}
<div className="group flex flex-col gap-4 p-5 bg-white  rounded-xl shadow-sm hover:shadow-md transition-all border border-slate-100  cursor-pointer">
...
<p className="text-slate-900  text-lg font-bold leading-normal">Getting Started</p>
</div>
<p className="text-slate-500  text-sm font-normal leading-relaxed">Everything you need to know about setting up your host profile and first listing.</p>
</div>
</div>
{/*  Category Card 2  */}
<div className="group flex flex-col gap-4 p-5 bg-white  rounded-xl shadow-sm hover:shadow-md transition-all border border-slate-100  cursor-pointer">
...
<p className="text-slate-900  text-lg font-bold leading-normal">Managing Bookings</p>
</div>
<p className="text-slate-500  text-sm font-normal leading-relaxed">Manage check-ins, guest communication, cancellations, and house rules.</p>
</div>
</div>
{/*  Category Card 3  */}
<div className="group flex flex-col gap-4 p-5 bg-white  rounded-xl shadow-sm hover:shadow-md transition-all border border-slate-100  cursor-pointer">
...
<p className="text-slate-900  text-lg font-bold leading-normal">Payment Issues</p>
</div>
<p className="text-slate-500  text-sm font-normal leading-relaxed">Detailed info on payouts, taxes, security deposits, and payment disputes.</p>
</div>
</div>
</div>
{/*  Popular Articles Section  */}
<div className="px-4 py-8">
<h2 className="text-slate-900  text-xl font-bold mb-4">Popular Help Articles</h2>
<div className="space-y-3">
<a className="flex items-center justify-between p-4 bg-white  rounded-lg border border-slate-100  hover:border-primary/50 transition-colors" href="#">
<div className="flex items-center gap-4">
<span className="material-symbols-outlined text-slate-400">description</span>
<span className="text-slate-700  font-medium">How to optimize your listing for better ranking</span>
</div>
...
<div className="flex items-center gap-4">
<span className="material-symbols-outlined text-slate-400">description</span>
<span className="text-slate-700  font-medium">Understanding the host cancellation policy</span>
</div>
<span className="material-symbols-outlined text-slate-300">chevron_right</span>
</a>
<a className="flex items-center justify-between p-4 bg-white  rounded-lg border border-slate-100  hover:border-primary/50 transition-colors" href="#">
<div className="flex items-center gap-4">
<span className="material-symbols-outlined text-slate-400">description</span>
<span className="text-slate-700  font-medium">How to report a guest for rule violations</span>
</div>
<span className="material-symbols-outlined text-slate-300">chevron_right</span>
</a>
</div>
...
<div className="m-4 mt-8 p-8 bg-primary/10  rounded-2xl border-2 border-dashed border-primary/30 flex flex-col md:flex-row items-center justify-between gap-6">
<div className="text-center md:text-left">
<h3 className="text-slate-900  text-xl font-bold mb-2">Still need help?</h3>
<p className="text-slate-600 ">Our support team is available 24/7 to assist you with any questions or technical issues.</p>
</div>
