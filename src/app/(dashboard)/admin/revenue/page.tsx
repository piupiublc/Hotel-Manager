        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-surface p-6 rounded-xl shadow-sm border border-outline-variant/50 space-y-4">
            ...
            <div>
              ...
              <h2 className="text-2xl font-extrabold text-on-background">1,142 VND</h2>
            </div>
            <div className="h-1 w-full bg-slate-100 rounded-full overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-surface p-8 rounded-xl shadow-sm border border-outline-variant/50 relative overflow-hidden min-h-[400px]">
            ...
            <div className="absolute inset-0 bg-slate-50 flex items-center justify-center">
              <div className="w-full h-full opacity-20 grayscale mix-blend-multiply bg-[url('https://images.unsplash.com/photo-1524661135-423995f22d0b?q=80&w=2074&auto=format&fit=crop')]" data-alt="Subtle world map background texture"></div>
              ...
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-slate-100">
                  <tr className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="px-4 py-4 text-right font-extrabold">4,200.00 VND</td>
                  </tr>
                  <tr className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="px-4 py-4 text-right font-extrabold">184.50 VND</td>
                  </tr>
                  <tr className="hover:bg-slate-50/50 transition-colors">
